...
#[inline(always)]
pub fn frustum<'a, 'b, T: Num>(out: &'a mut [T; 16], top: T, right: T, bottom: T, left: T, near: T, far: T) -> &'a mut [T; 16] {
...
#[inline(always)]
pub fn orthographic<'a, 'b, T: Num>(out: &'a mut [T; 16], top: T, right: T, bottom: T, left: T, near: T, far: T) -> &'a mut [T; 16] {
    let w = right - left;
    let h = top - bottom;
    let p = far - near;
